      ...
      <div className="row g-0">
       ...
       <>
        <div className="card-body mt-0 pt-0">
         ...
         {product.rating ? (
          <ReactStars classNames="mb-2" count={5} name="rating" value={Number([product.rating])} size={24} edit={false} isHalf={true} position="center" activeColor="#ffd700" />
         ) : ''}
      
         <button onClick={() => addToCart(product)}  className="btn btn-danger  text-center w-25">Add to cart</button>
        </div>
        </>
       </div>
      </div>
